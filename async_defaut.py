...
async def recreate_collection(_schema, _index_params):
    ...
    await async_milvus_client.create_collection(collection_name, schema=_schema, index_params=_index_params,
...
async def dql_async_task():
    ...
    task = async_milvus_client.hybrid_search(collection_name, [req, req2], RRFRanker(), default_limit,
...
if __name__ == '__main__':
    ...
    #  create
    loop.run_until_complete(recreate_collection(schema, index_params))
